...
const resetFilters = () => {
    ...
    prodiId.value = 'all';
    currentPage.value = 1;
    router.get('/superadmin/alumni', {}, { preserveState: true });
};
</script>
...
<template>
    ...
    <div class="min-h-screen bg-[#f8fafc] text-gray-800 font-sans pb-24">
        ...
        <main class="w-full max-w-[1400px] mx-auto -mt-10 px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <!-- 4 Kartu Statistik Ringkas & Profesional (Tanpa border tebal, tanpa warna campur) -->
            ...
            <!-- Panel Filter Komprehensif (Card Putih Bersih, Input Rapih, Tanpa Border Bertumpuk) -->
            <div class="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <!-- Tabel Mahasiswa ala DataTables (Bersih, Tanpa Border Hover) -->
                    ...
                    <table class="w-full text-left text-xs">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            >
                                ...
                                <!-- Status Akhir (Hanya Hijau Resmi UKDW #0D542B dan Kuning Resmi #FDC700 TANPA Border) -->
                                <td class="py-4 px-5 text-center">
                                    <span 
